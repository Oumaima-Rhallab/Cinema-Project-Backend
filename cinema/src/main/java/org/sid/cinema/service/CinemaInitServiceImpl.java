...
public class CinemaInitServiceImpl  implements ICinemaInitService{
	...
	public void initCategories() {
		Stream.of("Histoire","Drame","Actions","Fiction").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("12 Hommes en colere","Forrest Gump"
				,"Green Book","La Ligne Verte","Le Parrin","Le Seigneur des anneaux")
		.forEach(titreFilm->{
			Film film =new Film();
